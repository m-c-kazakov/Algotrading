...
INSERT INTO information_of_indicator(hash_code, indicator_type, information_of_candles_id, parameters) VALUES (3, 'SMA', 1, '{"CALCULATE_BY":"OPEN", "PERIOD":5}');
INSERT INTO information_of_indicator(hash_code, indicator_type, information_of_candles_id, parameters) VALUES (4, 'SMA', 2, '{"CALCULATE_BY":"OPEN", "PERIOD":10}');
...
INSERT INTO specification_of_strategy(statistics_of_strategy_id, hash_code, start_score, acceptable_risk,
...
VALUES (1, 123123123, 100, 10, 'PERCENT_OF_SCORE', '{"PERCENT_OF_SCORE": 2}', 'FIXED_STOP_LOSS', '{"FIXED_STOP_LOSS": 3}',
