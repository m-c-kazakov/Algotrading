...
public class DataOfStrategyGenerationServiceImpl implements DataOfStrategyGenerationService {
    ...
    public ResponseDataOfStrategy generate(RequestDataOfStrategy request) {
        ...
        byte[] decisionOnOpeningDeal = dealDecisionService.makeDecisionOnOpeningDeal(request.getTheSmallestTimeFrame(), request.getDescriptionToOpenADeal(), dataOfCurrencyPairMap);
